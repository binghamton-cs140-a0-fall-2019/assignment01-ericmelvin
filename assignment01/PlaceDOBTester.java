...
public class PlaceDOBTester {
	public static void main(String[] args) {
		...
		// Print 5 DateAndPlaceOfBirth objects to screen
		...
		// Print non-getter methods for object 1 to screen
		...
		// Print non-getter methods for object 2 to screen
		...
		// Print non-getter methods for object 3 to screen
		...
		// Print non-getter methods for object 4 to screen
		...
		// Print non-getter methods for object 5 to screen
